...
Backend #3: tool_result => Analysis complete`;
  ...
  describe('SubagentMapperImpl', () => {
    ...
    it('should validate models correctly', () => {
      expect(mapper.validateModel('claude', 'sonnet-4.6')).toBe(true);
      expect(mapper.validateModel('claude', 'haiku-4.5')).toBe(true);
      expect(mapper.validateModel('claude', 'opus-4.6')).toBe(true);
    ...
    it('should get default models', () => {
      expect(mapper.getDefaultModel('claude')).toBe('sonnet-4.6');
    ...
    it('should get available subagents', () => {
      ...
      expect(subagents).toEqual(['claude', 'cursor', 'codex', 'gemini', 'pi']);
    });
