  ...
  static getAvailableSubagents(): SubagentInfo[] {
    return [
      ...
      },
      {
        ...
        models: ['auto','gpt-5','sonnet-4.6', 'sonnet-4', 'sonnet-4-thinking'],
      ...
      {
        name: 'pi',
        description: 'Pi Coding Agent - Multi-provider terminal coding agent',
        capabilities: ['coding', 'multi-provider', 'tool-use', 'reasoning'],
...
export class SubagentMapperImpl {
  ...
  validateModel(subagentType: string, model: string): boolean {
    const validModels: Record<string, string[]> = {
      ...
      'cursor': ['auto','gpt-5','sonnet-4', 'sonnet-4.6', 'sonnet-4-thinking'],
      'codex': ['gpt-5'],
  ...
  getAvailableSubagents(): string[] {
    return ['claude', 'cursor', 'codex', 'gemini', 'pi'];
  }
