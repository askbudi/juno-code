...
export class CommandNotFoundError extends CLIError {
  ...
  constructor(
    ...
    options?: { context?: Partial<ErrorContext>; cause?: Error },
  ) {
    ...
    super(message, {
      ...
      context: {
        ...options?.context,
        metadata: { command, availableCommands, ...options?.context?.metadata },
      },
      cause: options?.cause,
      recoveryActions: [
        {
          id: 'suggest_similar_command',
          description: 'Suggest similar commands',
...
export class InvalidArgumentsError extends CLIError {
  ...
  constructor(
    ...
    super(`Invalid arguments for command '${command}': ${invalidArgs.join(', ')}`, {
      ...
      context: {
        ...options?.context,
        metadata: { command, invalidArgs, ...options?.context?.metadata },
      },
      cause: options?.cause,
      recoveryActions: [
        {
          id: 'show_command_help',
