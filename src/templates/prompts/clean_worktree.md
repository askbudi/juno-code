...
10. Require a typed integration receipt with `outcome=integrated`, risk/review/runtime truth, and feature-tag policy. High/release requires a local `juno-feature/<task>/<sha>` tag; low/medium skips it by default and may request it.
