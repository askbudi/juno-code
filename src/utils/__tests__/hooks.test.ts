...
describe('hooks', () => {
  ...
  describe('auto-migration functionality', () => {
    ...
    it('should migrate deprecated Claude model names to :sonnet shorthand', async () => {
      const { loadConfig } = await import('../../core/config.js');
    ...
    it('should migrate deprecated Haiku model names to :haiku shorthand', async () => {
      const { loadConfig } = await import('../../core/config.js');
    ...
    it('should migrate deprecated Opus model names to :opus shorthand', async () => {
      const { loadConfig } = await import('../../core/config.js');
    ...
    it('should migrate deprecated Codex model names to :codex shorthand', async () => {
      const { loadConfig } = await import('../../core/config.js');
    ...
    it('should migrate deprecated Gemini model names to shorthand', async () => {
      const { loadConfig } = await import('../../core/config.js');
