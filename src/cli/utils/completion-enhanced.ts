/**
 * Enhanced Shell Completion Utilities for yylo CLI
 *
...
export class CompletionInstaller {
  ...
  async install(shell: ShellType): Promise<InstallResult> {
    try {
      ...
      const script = this.generateEnhancedCompletion(shell, 'yylo');
...
# Generated by yylo CLI with context-aware features
